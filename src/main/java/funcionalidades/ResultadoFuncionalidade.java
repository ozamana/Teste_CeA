...
public class ResultadoFuncionalidade {
	...
	/**
	 * Realiza a expansão dos elementos de perguntas frequentes, apresentados
	 * na tela de "Ajuda"
	 */
	...
	/**
	 * Valida todas as informações institucionais como Telefone, Atendimento,
	 * Onde localizar, Onde comprar cartão e enviar currículo
	 */
